...
#SBATCH --gres=gpu:1
#SBATCH -p gpu
#SBATCH -o earlyexit_train_%j.out
#SBATCH -e earlyexit_train_%j.err 
...
export PATH=/n/home05/tinagong/.conda/envs/NNBP-OSD/bin:$PATH
...
echo "First pass of model done. Starting training with early exit thresholds..."
python3 train_segmentation.py --config configs/config_unet_ct_multi_att_dsv.json